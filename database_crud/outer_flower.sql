...
--
-- Хост: localhost:3306
-- Время создания: Ноя 23 2023 г., 13:17
...
INSERT INTO `flower_objects` (`id`, `title`, `image`, `description`, `info`) VALUES
...
(2, 'Ромашки', 'https://img.freepik.com/premium-photo/camomile-in-the-nature-camomile-daisy-flowers-field-in-summer-day-chamomile-flowers-background_73990-1100.jpg', 'Рассказываю о ромашках', 'Ромашка – это абсолютно неприхотливое растение, цветущее в первый год жизни. Имеет тонкий стебель и узкие зеленые листья. Цветки состоят из яркой желтой сердцевины и вытянутых белоснежных лепестков. Они собраны в корзиночки небольшими группами, благодаря чему цветение кажется пышным.'),
(3, 'Лилии', 'https://flowers.ua/images/Flowers/articles/304-img-1.jpg', 'Рассказываю о лилиях', 'Лилия — род растений семейства Лилейные. Многолетние травы, снабжённые луковицами, состоящими из мясистых низовых листьев, расположенных черепитчато, белого, розоватого или желтоватого цвета.'),
